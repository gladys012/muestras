        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Determinación de PH y Densidad</h3>                        
                    <b-button variant="info  pull-right" @click="abrirModal('ph_densidad','registrar')" style="right:0;"><b-icon-plus font-scale="1.5"></b-icon-plus>Nuevo</b-button>
                </div>
                <div class="card-body"> 
                    <b-row>                        
                    ...
                    >
                        ...
                        <template v-slot:head(densidad)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template>  
                        <template v-slot:head(ph)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template>   
                        ...
                        <a href="#" @click="abrirModal('ph_densidad','actualizar',row.item)" v-b-tooltip.hover title="Actualizar">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <b-form @submit="onSubmit" v-if="show">
                       ...
                       <div class="row">                           
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-3"  label="Densidad:" label-for="input-2" >
                                <b-form-input id="input-3" v-model="densidad" placeholder="Densidad" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                          <div class="form-group col-sm-4">
                      ...
                      <div class="modal-footer">
                        ...
                        <b-button type="submit" v-if="tipoAccion==1" variant="primary" @click="registrarPh_densidad()">Guardar</b-button>
                        <b-button type="submit" v-if="tipoAccion==2" variant="primary" @click="actualizarPh_densidad()">Actualizar</b-button>
                      </div>
                    </b-form>                   
                </div>                
            </div>
        ...
        data (){            
            return {
                ...
                columnas: [
                  ...
                  { key: 'densidad', label: 'Densidad', sortable: true },                 
        ...
        methods : {
            ...
            listarPh_densidad (){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayPh_densidad = respuesta.ph_densidad.data;
                    me.totalRows = me.arrayPh_densidad.length;
                    console.log(me.arrayPh_densidad,'me.arrayPh_densidad...');
                })
            ...
            actualizarPh_densidad(){             
                let me = this;
                this.fechaD = moment(this.fechaD).format('D/MM/YYYY');
                axios.put('/ph_densidad/actualizar',{
                    'idpreparacion': this.idpreparacion, 
                    'densidad': this.densidad,
                    'fecha': this.fechaD,
                    'codigo_lab' : this.codigo_lab,
