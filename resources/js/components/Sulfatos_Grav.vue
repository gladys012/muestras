        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Determinación de Sulfatos por Gravimetría</h3>                        
                    <b-button variant="info  pull-right" @click="abrirModal('sulfatos_grav','registrar')" style="right:0;"><b-icon-plus font-scale="1.5"></b-icon-plus>Nuevo</b-button>
                </div>
                <div class="card-body"> 
                    <b-row>                        
                    ...
                    >
                        ...
                        <template v-slot:head(nro_crisol)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template>   
                        ...
                        <a href="#" @click="abrirModal('sulfatos_grav','actualizar',row.item)" v-b-tooltip.hover title="Actualizar">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <b-form @submit="onSubmit" v-if="show">
                       ...
                       <div class="row">                           
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-3"  label="Nro. vaso:" label-for="input-2" >
                                <b-form-input id="input-3" v-model="nro_vaso" placeholder="Nro. vaso" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                          <div class="form-group col-sm-4">
                         ...
                         <div class="form-group col-sm-4">
                            <b-form-group id="input-group-5"  label="Nro. crisol:" label-for="input-5" >
                                <b-form-input id="input-5" v-model="nro_crisol" placeholder=" Nro. crisol" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div>                                                                           
                       </div>
                       <div class="row">                           
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-3"  label="Masa crisol:" label-for="input-2" >
                                <b-form-input id="input-3" v-model="masa_crisol" placeholder="Masa crisol" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                          <div class="form-group col-sm-4">
                      ...
                      <div class="modal-footer">
                        ...
                        <b-button type="submit" v-if="tipoAccion==1" variant="primary" @click="registrarSulfato_grav()">Guardar</b-button>
                        <b-button type="submit" v-if="tipoAccion==2" variant="primary" @click="actualizarSulfato_grav()">Actualizar</b-button>
                      </div>
                    </b-form>                   
                </div>                
            </div>
...
<script>
    ...
    export default {
        data (){            
            return {
                ...
                columnas: [
                  ...
                  { key: 'nro_vaso', label: 'Nro. vaso', sortable: true },                 
                  { key: 'masa_muestra', label: 'Masa muestra', sortable: true },                 
                  { key: 'nro_crisol', label: 'Nro. crisol', sortable: true },                 
        ...
        methods : {
            ...
            listarSulfato_grav (){
                let me=this;
                var url= '/sulfatos_grav';
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arraySulfato_grav = respuesta.sulfatos_grav.data;
            ...
            actualizarSulfato_grav(){             
                let me = this;
                this.fechaD = moment(this.fechaD).format('D/MM/YYYY');
                axios.put('/sulfatos_grav/actualizar',{
                    'idpreparacion': this.idpreparacion, 
                    'nro_vaso': this.nro_vaso,
                    'fecha': this.fechaD,
                    'codigo_lab' : this.codigo_lab,
                    ...
                    case "sulfatos_grav":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.nro_vaso=data['nro_vaso'];
                                this.masa_muestra=data['masa_muestra'];
                                this.masa_c_m=data['masa_c_m'];
                                this.observaciones=data['observaciones'];
                                this.masa_crisol= data['masa_crisol'];
                                this.nro_crisol= data['nro_crisol'];
                                break;
                            }
                        }
                    }
