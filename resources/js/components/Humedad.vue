        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Determinacion de la Humedad</h3>                        
                    <b-button variant="info  pull-right" @click="abrirModal('humedad','registrar')" style="right:0;"><b-icon-plus font-scale="1.5"></b-icon-plus>Nuevo</b-button>
                </div>
                <div class="card-body"> 
                    <b-row>                        
                    ...
                    >
                        ...
                        <template v-slot:head(peso_cp)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template>  
                        <template v-slot:head(peso_cp_mh)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template> 
                        <template v-slot:head(peso_cp_ms)="data">
                            <span class="text-primary">{{ data.label }}</span>
                        </template>                           
                        ...
                        <a href="#" @click="abrirModal('humedad','actualizar',row.item)" v-b-tooltip.hover title="Actualizar">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <b-form @submit="onSubmit" v-if="show">
                       ...
                       <div class="row">                           
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-3"  label="Peso CP:" label-for="input-2" >
                                <b-form-input id="input-3" v-model="peso_cp" placeholder="Peso CP" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-4"  label="Peso CP+MH:" label-for="input-4" >
                                <b-form-input id="input-4" v-model="peso_cp_mh" placeholder="Peso CP+MH" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                         <div class="form-group col-sm-4">
                            <b-form-group id="input-group-5"  label="Peso CP+MS:" label-for="input-5" >
                                <b-form-input id="input-5" v-model="peso_cp_ms" placeholder=" Peso CP+MS" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div>                                                                           
                       </div>                       
                      ...
                      <div class="modal-footer">
                        ...
                        <b-button type="submit" v-if="tipoAccion==1" variant="primary" @click="registrarHumedad()">Guardar</b-button>
                        <b-button type="submit" v-if="tipoAccion==2" variant="primary" @click="actualizarHumedad()">Actualizar</b-button>
                      </div>
                    </b-form>                   
                </div>                
            </div>
        ...
        data (){            
            return {
                ...
                columnas: [
                  ...
                  { key: 'peso_cp', label: 'Peso CP', sortable: true },                 
                  { key: 'peso_cp_mh', label: 'Peso CP+MH', sortable: true },                 
                  { key: 'peso_cp_ms', label: 'Peso CP+MS', sortable: true },                 
        ...
        methods : {
            ...
            listarHumedad (){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayHumedad = respuesta.humedads.data;
                    me.totalRows = me.arrayHumedad.length;
                    console.log(me.arrayHumedad,'me.arrayHumedad...');
                })
            ...
            registrarHumedad(){ 
                ...
                let me = this;
                    console.log('entra 0');
                        axios.post('/humedad/registrar',{
                        'idpreparacion': this.idpreparacion,    
                        'peso_cp': this.peso_cp,
                        'fecha': this.fechaD,
                        'codigo_lab' : this.codigo_lab,
                        'peso_cp_mh' : this.peso_cp_mh,
                        'peso_cp_ms' : this.peso_cp_ms,
                ...
                switch(modelo){
                    case "humedad":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar  Detalle humedad';
                                this.idpersona= 0;
                                this.fechaD = new Date(),
                                this.codigo_lab = '';
                                this.peso_cp = '';
                            ...
                            {
                                this.modal=1;
                                this.tituloModal='Actualizar  Detalle humedad';
                                this.tipoAccion=2;
                                this.humedad_id=data['id'];
                                this.idpreparacion=data['idpreparacion'];
                                this.fechaD = data['fecha'];
                                this.codigo_lab=data['codigo_lab'];
                                this.peso_cp=data['peso_cp'];
                                this.peso_cp_mh=data['peso_cp_mh'];
                                this.observaciones=data['observaciones'];
                                this.peso_cp_ms= data['peso_cp_ms'];
                                break;
                            }
                        }
                    }
