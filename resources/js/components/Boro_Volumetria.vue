        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Determinación de Boro por Volumetría</h3>                        
                    <b-button variant="info  pull-right" @click="abrirModal('boro_volumetria','registrar')" style="right:0;"><b-icon-plus font-scale="1.5"></b-icon-plus>Nuevo</b-button>
                </div>
                <div class="card-body"> 
                    <b-row>                        
                    ...
                    >
                        ...
                        <a href="#" @click="abrirModal('boro_volumetria','actualizar',row.item)" v-b-tooltip.hover title="Actualizar">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <b-form @submit="onSubmit" v-if="show">
                       ...
                       <div class="row">                           
                          <div class="form-group col-sm-4">
                            <b-form-group id="input-group-3"  label="Vol. gastado blanco:" label-for="input-2" >
                                <b-form-input id="input-3" v-model="vol_gastado_blanco" placeholder="Vol. gastado blanco" required                            
                                ></b-form-input>
                            </b-form-group>
                         </div> 
                          <div class="form-group col-sm-4">
                      ...
                      <div class="modal-footer">
                        ...
                        <b-button type="submit" v-if="tipoAccion==1" variant="primary" @click="registrarboro_volumetria()">Guardar</b-button>
                        <b-button type="submit" v-if="tipoAccion==2" variant="primary" @click="actualizarboro_volumetria()">Actualizar</b-button>
                      </div>
                    </b-form>                   
                </div>                
            </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            listarBoro_volumetria (){
                let me=this;
                var url= '/boro_volumetria';
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayboro_volumetria = respuesta.boro_volumetria.data;
                    me.totalRows = me.arrayboro_volumetria.length;
                    console.log(me.arrayboro_volumetria,'me.arrayboro_volumetria...');
                })
            ...
            actualizarboro_volumetria(){             
                let me = this;
                this.fechaD = moment(this.fechaD).format('D/MM/YYYY');
                axios.put('/boro_volumetria/actualizar',{
                    'idpreparacion': this.idpreparacion, 
                    'dil': this.dil,
                    'fecha': this.fechaD,
                    'codigo_lab' : this.codigo_lab,
            ...
            abrirModal(modelo, accion, data = []){
                switch(modelo){
                    case "boro_volumetria":
                    {
                        switch(accion){
                            case 'registrar':
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar detalle boro por volumetría';
                                this.idpersona= 0;
                                this.fechaD = new Date(),
                                this.codigo_lab = '';
                                this.dil = '';
                            ...
                            {
                                this.modal=1;
                                this.tituloModal='Actualizar detalle boro por volumetría';
                                this.tipoAccion=2;
                                this.boro_volumetria_id=data['id'];
